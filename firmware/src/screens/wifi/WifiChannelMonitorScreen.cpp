...
void WifiChannelMonitorScreen::onInit()
{
...
void WifiChannelMonitorScreen::onUpdate()
{
  if (_quitting) return;
...
void WifiChannelMonitorScreen::onRender()
{
  if (_quitting) return;
...
void WifiChannelMonitorScreen::_hop()
{
...
void WifiChannelMonitorScreen::_quit()
{
  _quitting = true;
