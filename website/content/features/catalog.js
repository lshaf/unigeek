...
export const CATALOG = [
  ...
  { slug: "sub-ghz",              title: "Sub-GHz (CC1101)",    category: "module",   summary: "Capture, replay, and jam Sub-GHz RF signals — 38 brand/manufacturer protocol decoders, peak frequency detector, live RAW/Code receive filter, continuous RAW waveform recorder (Bruce-style, records until stop with live wave/RSSI animation), scrollable Signal Info view, KeeLoq auto-decode + counter-step (Replay +1) rolling-code replay; compatible with Flipper Zero .sub format", hasDetail: true,  stable: true },
