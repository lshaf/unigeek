...
export const CATALOG = [
  ...
  { slug: "karma-detector",      title: "Karma Detector",      category: "wifi",     summary: "Detect rogue APs responding to probes by broadcasting fake probe requests across channels and monitoring responses", hasDetail: false, stable: true },
  ...
  { slug: "wifi-watchdog",        title: "WiFi Watchdog",       category: "wifi",     summary: "Passive promiscuous monitor — deauth events, probe leaks, beacon flood detection, and evil twin detection across five views", hasDetail: false, stable: true },
  { slug: "beacon-attack",        title: "Beacon Attack",       category: "wifi",     summary: "Flood the area with fake SSIDs — Spam mode (dictionary or random names) or Flood mode targeting a specific AP", hasDetail: false, stable: true },
